 ...
 *
 * @author Tim Pierson, Dartmouth CS 10, Winter 2025, based on prior terms Webcam
 *
 */
public class VideoGUI extends ImageGUI {
    ...
    JLabel standbyLabel = new JLabel();				// notice to wait for camera to start
    ...
    public VideoGUI(String title) {
        ...
        //alert users to wait for camera to start
        System.out.println("Standby while the camera starts...");
        standbyLabel.setFont(new Font("Menlo",1,20));
        standbyLabel.setText("Standby while the camera starts...");
        standbyLabel.setBounds(0, 0, 500, 50);
    ...
    private void initWindow(int width, int height) {
        ...
        //remove standby label
        panel.remove(standbyLabel);
