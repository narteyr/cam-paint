...
public class ImageGUI extends JFrame {
	...
	/**
	 * Update left image with new image from disk
	 * Set the first image and repaint to refresh window with new image on the screen by calling setImage1
	...
	/**
	 * Update left image with new image passed as parameter
	 * Set the first image and repaint to refresh window with new image on the screen by calling setImage1
	...
	/**
	 * Update right image with new image from disk
	...
	/**
	 * Update right image with new image passed as parameter
	 * Set the second image and repaint to refresh window with new image on the screen
